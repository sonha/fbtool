                                        ...
                                        <div class="col-md-3 thumbnail" >
                                            <div class="tile-container" style="margin-bottom:0px">
                                                ...
                                                <div class="tile-title">
                                                    <h3>
                                                        <a href="<?php echo $value['link']?>" target="_blank">Title Here</a>
                                                    </h3>


                                                    <div class="tile-desc">
                                                        <p>Activity:
                                                            <a href="<?php echo $value['pinner_name']?>"><?php echo $value['pinner_name']?></a> -
                                                            <span class="font-grey-salt"><?php echo $value['created_at'];?></span>
                                                        </p>
