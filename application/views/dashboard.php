                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <div id="site_activities_loading">
                                            <img src="<?php echo base_url() ?>assets/codeto/theme/assets/global/img/loading.gif" alt="loading" /> </div>
                                                ...
                                                <div class="mt-comments">
                                                    <div class="mt-comment">
                                                        <div class="mt-comment-img">
                                                            <img src="<?php echo base_url() ?>assets/codeto/theme/assets/pages/media/users/avatar1.jpg" /> </div>
                                                    ...
                                                    <div class="mt-comment">
                                                        <div class="mt-comment-img">
                                                            <img src="<?php echo base_url() ?>assets/codeto/theme/assets/pages/media/users/avatar6.jpg" /> </div>
                                                        <div class="mt-comment-body">
                                                            <div class="mt-comment-info">
                                                    ...
                                                    <div class="mt-comment">
                                                        <div class="mt-comment-img">
                                                            <img src="<?php echo base_url() ?>assets/codeto/theme/assets/pages/media/users/avatar8.jpg" /> </div>
                                                        <div class="mt-comment-body">
                                                            <div class="mt-comment-info">
                                                    ...
                                                    <div class="mt-comment">
                                                        <div class="mt-comment-img">
                                                            <img src="<?php echo base_url() ?>assets/codeto/theme/assets/pages/media/users/avatar4.jpg" /> </div>
                                                        <div class="mt-comment-body">
                                                            <div class="mt-comment-info">
